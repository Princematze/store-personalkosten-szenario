    ...
    rows = [
        {
            ...
            "Veränderung": delta_teur(new_revenue - plan_revenue),
        ...
        },
        {
            ...
            "Veränderung": delta_teur(new_pc - plan_pc),
        ...
        },
        {
            ...
            "Veränderung": delta_teur(new_fixed * (1 + wage_change) - base_fixed),
        ...
        },
        {
            ...
            "Veränderung": delta_teur(new_semi * (1 + wage_change) - base_semi),
        ...
        },
        {
            ...
            "Veränderung": delta_teur(new_variable * (1 + wage_change) - base_variable),
        ...
        },
        {
            ...
            "Veränderung": delta_teur(one_off),
            "_delta": one_off,
            "_logic": "cost",
        },
    ]
