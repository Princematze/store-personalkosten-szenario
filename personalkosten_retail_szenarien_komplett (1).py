...
if productivity_change > 10 and variable_hours_change > 0:
    warnings.append(
        "Hohe Produktivitätssteigerung und gleichzeitig steigende variable Stunden "
        "wirken möglicherweise widersprüchlich."
    )

if not math.isnan(new_ratio) and new_ratio > base_ratio + 0.03:
    warnings.append(
        "Die Personalkostenquote steigt um mehr als 3 Prozentpunkte."
    )
